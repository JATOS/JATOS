 ...
 * Multiple Worker. A General Multiple Worker is a worker for an external run, the
 * worker can run the study many times. The worker is created during start of the
 * study.
 *
