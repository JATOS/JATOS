...
public class MessagesStrings {
    ...
    public static final String NOT_A_VALID_PATH_YOU_CAN_LEAVE_IT_EMPTY =
            "Not a valid path or filename. Remember to use '/' as folder separator, and to include the file extension. You can leave it empty for now.";
    public static final String JSON_DATA_MISSING_OR_INVALID_JSON_FORMAT =
            "JSON data missing or invalid JSON format";
    public static final String STUDY_AT_LEAST_ONE_USER =
            "A study needs at least one user.";
    public static final String STUDY_IS_LOCKED =
            "Study is locked. It's not possible to edit.";
    ...
    public static final String BATCH_NOT_ALLOWED_DELETE_DEFAULT =
            "It's not allowed to delete the default batch.";
    public static final String BATCH_MAX_ACTIVE_MEMBERS_SET =
            "Group's max acitive members size must be set if you want to limit it.";
    public static final String BATCH_MAX_ACTIVE_MEMBERS =
            "Group's max active member size must be greater or equal than the min one.";
    public static final String BATCH_MAX_TOTAL_MEMBERS_SET =
            "Group's max total members size must be set if you want to limit it.";
    public static final String BATCH_MAX_TOTAL_MEMBERS =
            "Group's max total members size must be greater or equal than the max active member size.";
    public static final String BATCH_MAX_TOTAL_WORKER_SET =
            "Batch's max total worker size must be set if you want to limit it.";
    public static final String BATCH_MAX_TOTAL_WORKERS =
            "Batch's max total worker size must be at least 1.";

    // User
    public static final String INVALID_USER_OR_PASSWORD =
            "Invalid user or password";
    public static final String FAILED_THREE_TIMES =
            "You failed three times. Now you have to wait for a minute before you can try again.";
    public static final String WRONG_PASSWORD = "Wrong password";
    public static final String NOT_ALLOWED_TO_CHANGE_PASSWORDS =
            "You are not allowed to change passwords.";
    public static final String NOT_ALLOWED_TO_DELETE_USER =
    ...
    public static final String PASSWORDS_SHOULDNT_BE_EMPTY_STRINGS =
            "Passwords shouldn't be empty strings";
    public static final String THIS_EMAIL_IS_ALREADY_REGISTERED =
    ...
    public static final String NOT_ALLOWED_REMOVE_ADMINS_ADMIN_RIGHTS =
            "It's not possible to remove 'admin's admin rights.";
    public static final String NOT_ALLOWED_DELETE_ADMIN =
            "It's not possible to remove user 'admin'.";
    public static final String NOT_ALLOWED_CHANGE_PW_ADMIN =
            "It's not possible to change 'admin's password.";

    // Export / import
    public static final String NO_COMPONENT_UPLOAD =
            "Uploaded file isn't intended for components";
    public static final String NO_STUDY_UPLOAD =
            "Uploaded file isn't intended for studies";
    public static final String MORE_THAN_ONE_DIR_IN_ZIP =
            "There are more than one directory in the ZIP file.";
    public static final String NO_DIR_IN_ZIP_CREATED_NEW =
            "There is no directory in the ZIP file - new study assets created.";
    ...
    public static final String FILE_NOT_EXIST_OR_DIR =
            "File doesn't exists or is a directory";
    public static final String IMPORT_OF_STUDY_FAILED =
            "Import of study failed";
    public static final String IMPORT_OF_COMPONENT_FAILED =
            "Import of component failed";
    public static final String NO_RESULTS_SELECTED = "No results selected";
    public static final String PROBLEM_GENERATING_JSON_DATA =
            "Problem generate JSON data";
    public static final String TOO_NEW_STUDY_VERSION =
            "This study is from an newer version of JATOS. Try updating your JATOS.";
    public static final String UNSUPPORTED_STUDY_VERSION =
            "This study is from an unsupported version of JATOS.";
    public static final String TOO_NEW_COMPONENT_VERSION =
            "This component is from an newer version of JATOS. Try updating your JATOS.";
    public static final String UNSUPPORTED_COMPONENT_VERSION =
            "This component is from an unsupported version of JATOS.";

    // Results
    public static final String RESULTS_COLUMN_VISIBILITY = "Show/hide columns";
    public static final String RESULTS_SELECT_ALL =
            "Select all results (including the ones on different table pages)";
    public static final String RESULTS_SELECT_FILTERED =
            "Select only the filtered results (including the ones on different table pages)";
    ...
    public static final String RESULTS_STUDY_MESSAGES =
            "Messages that occured during the run of this study";
    public static final String RESULTS_COMPONENT_STATE =
            "Current state of this component's run, like "
                    + ComponentState.allStatesAsString();
    public static final String RESULTS_COMPONENT_MESSAGES =
            "Messages that occured during the run of this component";

    // Other
    public static final String MTWORKER_ALLOWANCE_MISSING =
            "Right now workers from Mechnical Turk are not allowed to run this study. You should change this in this study's properties before you run it from Mechanical Turk.";
    public static final String COULDNT_GENERATE_JATOS_URL =
            "Couldn't generate JATOS' URL. Try to reload this page.";
    public static final String COULDNT_CHANGE_POSITION_OF_COMPONENT =
            "Couldn't change position of componet.";
    public static final String COMPONENT_DELETED_BUT_FILES_NOT =
            "Component deleted, but all files (e.g. its HTML file) in study assets remain untouched.";
    public static final String PROBLEM_GENERATING_BREADCRUMBS =
            "Problem generating breadcrumbs";
    ...
    public static String componentHasNoStudy(Long componentId) {
        return "The component with ID " + componentId
    ...
    public static String componentNotExist(Long componentId) {
        return "An component with ID " + componentId
                + " doesn't exist.";
    }

    public static String componentNotExist(Long studyId, Long componentId) {
        return "An component with ID " + componentId + " of study "
