...
CREATE TABLE `StudyResult` (
  ...
  `endDate` datetime DEFAULT NULL,
  `errorMsg` varchar(255) DEFAULT NULL,
  `activeGroupMember_id` bigint(20) DEFAULT NULL,
  `historyGroupMember_id` bigint(20) DEFAULT NULL,
  `startDate` datetime DEFAULT NULL,
...
ALTER TABLE `BatchWorkerMap` ADD KEY `FK_mbcbdskuq79ml24uipmioxu3s` (`worker_id`);
ALTER TABLE `BatchWorkerMap` ADD CONSTRAINT `FK_suo6v5gv8gpvgwdvi6tbshtrj` FOREIGN KEY (`batch_id`) REFERENCES `Batch` (`id`);
ALTER TABLE `BatchWorkerMap` ADD CONSTRAINT `FK_mbcbdskuq79ml24uipmioxu3s` FOREIGN KEY (`worker_id`) REFERENCES `Worker` (`id`);
...
ALTER TABLE `StudyResult` ADD KEY `FK_2vbvsrpwxwnqbd0rud8kfr9ur` (`activeGroupMember_id`);
ALTER TABLE `StudyResult` ADD KEY `FK_7052aavudt8sm5b6a3lhqn4uu` (`historyGroupMember_id`);
...
ALTER TABLE `StudyResult` ADD CONSTRAINT `FK_7052aavudt8sm5b6a3lhqn4uu` FOREIGN KEY (`historyGroupMember_id`) REFERENCES `GroupResult` (`id`);
ALTER TABLE `StudyResult` ADD CONSTRAINT `FK_2vbvsrpwxwnqbd0rud8kfr9ur` FOREIGN KEY (`activeGroupMember_id`) REFERENCES `GroupResult` (`id`);
...
INSERT INTO `User` VALUES ('admin', 'Admin', '21232f297a57a5a743894a0e4a801fc3');
