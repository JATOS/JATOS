 ...
 */
public class GuiTestGlobal extends GlobalSettings {

	private static final String CLASS_NAME = GuiTestGlobal.class.getSimpleName();
	...
	public void onStart(Application app) {
		Logger.info(CLASS_NAME + ".onStart: JATOS for GUI tests has started");
	}
