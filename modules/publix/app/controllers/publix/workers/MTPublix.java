...
public class MTPublix extends Publix<MTWorker> implements IPublix {
    ...
    public Result startStudy(Http.Request request, StudyRun studyRun) throws PublixException {
        ...
        String mtWorkerId = HttpUtils.getQueryString("workerId");
        String mtAssignmentId = HttpUtils.getQueryString("assignmentId");
        ...
        if (!worker.getWorkerType().equals(requestsWorkerType)) {
            throw new BadRequestPublixException("Wrong worker type: A worker with this MTurk workerId=" + mtWorkerId
                    ...
                    + " while your study run link is for type " + studyRun.getWorkerType() + ".");
        }
        ...
        studyLogger.log(study, "Started study run with " + MTWorker.UI_WORKER_TYPE + " worker", batch, worker);
