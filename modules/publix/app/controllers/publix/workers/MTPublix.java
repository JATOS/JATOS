...
public class MTPublix extends Publix implements IPublix {
    ...
    public Result startStudy(Http.Request request, StudyLink studyLink) {
        ...
        String mtWorkerId = HttpUtils.getQueryParameter("workerId");
        String mtAssignmentId = HttpUtils.getQueryParameter("assignmentId");
        WorkerType requestsWorkerType = retrieveWorkerTypeFromQueryString();
     ...
     * returns MTWorker.
     */
    private WorkerType retrieveWorkerTypeFromQueryString() {
        Optional<String> turkSubmitTo = Context.current().requestHeader().queryString("turkSubmitTo");
