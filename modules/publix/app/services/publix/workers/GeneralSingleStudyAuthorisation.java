...
public class GeneralSingleStudyAuthorisation extends StudyAuthorisation {
    ...
    @Inject
    GeneralSingleStudyAuthorisation(StudyResultDao studyResultDao,
                                    WorkerDao workerDao) {
    ...
    public void checkWorkerAllowedToStartStudy(Http.Session session, Worker worker, Study study, Batch batch) {
        ...
        // General Single Runs are used only once - don't start if the worker has a study result (except it is in state PRE)
