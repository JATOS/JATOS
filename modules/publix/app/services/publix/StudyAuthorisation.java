...
public abstract class StudyAuthorisation<T extends Worker> {
     ...
     */
    public abstract void checkWorkerAllowedToStartStudy(Http.Request request, Worker worker, Study study, Batch batch)
     ...
     */
    public abstract void checkWorkerAllowedToDoStudy(Http.Request request, Worker worker, Study study, Batch batch)
            throws ForbiddenPublixException;
