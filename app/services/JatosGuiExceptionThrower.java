...
public class JatosGuiExceptionThrower {
	...
	public void throwEditStudy(List<StudyModel> studyList,
		...
		if (ControllerUtils.isAjax()) {
			...
			result = Results.status(httpStatus, views.html.jatos.study.edit
	...
	public void throwEditComponent(List<StudyModel> studyList,
		...
		if (ControllerUtils.isAjax()) {
			...
			result = Results.status(httpStatus, views.html.jatos.component.edit
					.render(studyList, loggedInUser, breadcrumbs, null,
	...
	public void throwCreateUser(List<StudyModel> studyList,
		...
		if (ControllerUtils.isAjax()) {
			...
			result = Results.status(httpStatus, views.html.jatos.user.create
