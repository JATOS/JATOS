...
public class Study {
	...
	public void componentOrderMinusOne(Component component) {
		int index = componentList.indexOf(component);
		if (index > 0) {
			Component prevComponent = componentList.get(index - 1);
			componentOrderSwap(component, prevComponent);
		}
	}

	public void componentOrderPlusOne(Component component) {
		int index = componentList.indexOf(component);
		if (index < (componentList.size() - 1)) {
			Component nextComponent = componentList.get(index + 1);
			componentOrderSwap(component, nextComponent);
		}
	}

	public void componentOrderSwap(Component component1,
			Component component2) {
		int index1 = componentList.indexOf(component1);
		int index2 = componentList.indexOf(component2);
		Component.changeComponentOrder(component1, index2);
		Component.changeComponentOrder(component2, index1);
	}
